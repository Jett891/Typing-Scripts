// ==UserScript==
// @name         Blindtyping [Normal]
// @namespace    http://tampermonkey.net/
// @version      13.37
// @description  Shinigami
// @author       Shinigami
// @match        https://blindtyping.com/*
// @grant        none
// ==/UserScript==
...
(function() {
    ...
    const inputs = {
        errorChance: createInput('Error chance (%)', 20, 'errorChance'),
        neighborChars: createInput('Neighbor swap (%)', 30, 'neighborChars'),
        swapChars: createInput('Swap letters (%)', 30, 'swapChars'),
    ...
    function getTextFromDOM() {
        ...
        const wordDivs = wordsContainer.querySelectorAll('.TestWrapper_word__TI39_');
        const result = [];
        wordDivs.forEach(div => {
            const spans = div.querySelectorAll('span');
            let wordChars = [];
            spans.forEach(sp => wordChars.push(sp.textContent));
    ...
    function processKey(key) {
        ...
        const charToType = erroredText[charIndex];
        charIndex++;
